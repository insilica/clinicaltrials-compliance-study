...
\newcommand{\ISOtoLocaleDisplayDate}[1]{%
  \DTMsavedate{tempdate}{#1}% Save the date from ISO format
  \DTMusedate{tempdate}% Output the date in the current regional format
}
